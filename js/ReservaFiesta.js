...
(function() {
  ...
  if (confirmOk) {
    confirmOk.addEventListener('click', function() {
      document.getElementById('modal-confirm-overlay').setAttribute('hidden', '');
      var nino = document.getElementById('modal-tbl-nino') ? document.getElementById('modal-tbl-nino').textContent : '';
      var adulto = document.getElementById('modal-tbl-adulto') ? document.getElementById('modal-tbl-adulto').textContent : '';
      localStorage.setItem('fiesta_precio_nino', nino);
      localStorage.setItem('fiesta_precio_adulto', adulto);
    });
  }
})();
...
(function() {
  function actualizarTotal() {
    var adultos = parseInt(document.getElementById('adultos-val') ? document.getElementById('adultos-val').textContent : '0') || 0;
    var ninos = parseInt(document.getElementById('ninos-val') ? document.getElementById('ninos-val').textContent : '0') || 0;
    
    var strAdulto = localStorage.getItem('fiesta_precio_adulto') || '6';
    var strNino = localStorage.getItem('fiesta_precio_nino') || '21.95';
    
    var pAdulto = parseFloat(strAdulto.replace(/[^\d.,]/g, '').replace(',', '.')) || 6;
    var pNino = parseFloat(strNino.replace(/[^\d.,]/g, '').replace(',', '.')) || 21.95;

    var total = (adultos * pAdulto) + (ninos * pNino);
